...
const STRINGS: Record<string, { zh: string; en: string }> = {
  ...
  'help.creditsTail':  { zh: '其余素材为 CC0 或本项目自有（中文语音为本地合成）。完整许可清单见仓库 THIRD_PARTY_NOTICES.md。', en: 'All other assets are CC0 or made in-house (Chinese voice lines are locally synthesized). Full license list: THIRD_PARTY_NOTICES.md in the repository.' },
