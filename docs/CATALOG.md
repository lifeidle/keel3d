...
| `open` | [`openworld.html`](../openworld.html) | 🌄 开放世界 | playable | `openworld` | `#cultivation-hud` |
...
| `flight` | [`flight.html`](../flight.html) | ✈️ 飞行 | playable | `flight` | `#flight-hud` |
| `flight-arena` | [`flight-arena.html`](../flight-arena.html) | 🛩️ 空战骨架 | skeleton | `flight-arena` | `#boot` |
| `race` | [`race.html`](../race.html) | 🏎️ 赛车 | playable | `race` | `#race-hud` |
...
| `race` | `raceRecipe` | `src/recipes/race.ts` | `race.html` |
| `flight` | `flightRecipe` | `src/recipes/flight.ts` | `flight.html` |
| `openworld` | `openworldRecipe` | `src/recipes/open.ts` | `openworld.html` |
