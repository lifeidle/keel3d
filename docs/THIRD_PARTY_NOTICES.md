...
再分发完整构建（尤其是夜袭 Sample A 的 dist）时，请保留本文件与游戏内「素材与致谢」。
...
| **完整夜袭样例构建**（含 CC-BY 音频） | ✅ 可以 | 完整署名；注意 CC-BY-SA 语音的 SA 义务或移除该语音 |
