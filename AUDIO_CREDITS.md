# 音频资产清单 / AUDIO ASSET REGISTER

最后更新：2026-09-06。本文件是游戏内全部音频的来源与许可底账。

## 总览

| 类别 | 来源 | 许可 |
|---|---|---|
| 背景音乐 ×4（menu / layer_calm / layer_tense / layer_battle） | OpenGameArt (Ruskerdax, CC0) / incompetech (Kevin MacLeod, CC-BY 4.0) | CC0 / CC-BY 4.0 |
| 胜负 Jingle ×3 | Kenney "Music Jingles" | CC0 |
| 枪声 ×4（cz / mosin / shotty / sks） | OpenGameArt "Gunshot Sounds"（Vincent Sevedge） | CC-BY 3.0 |
| 爆炸 ×1 | OpenGameArt "Explosion" | CC0 |
| 打击/命中/弹开/脚步/木箱 ×12 | Kenney "Impact Sounds" | CC0 |
| 换弹/干发/装填/炮塔 ×8 | Kenney "Impact Sounds" | CC0 |
| 鸟鸣环境声 ×1 | OpenGameArt（isaiah658） | CC0 |
