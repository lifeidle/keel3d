...
const files = ['ballistics', 'magazine', 'arsenal', 'extract-rest', 'char-tps', 'loot-inv', 'proc-dungeon', 'dialogue-xp', 'demo-feel', 'r8-extras', 'terrain', 'mapgen', 'combat', 'protocol', 'blocks', 'gameplay', 'interact', 'combat-blocks', 'excellence', 'controls-shell', 'roguelike-descent', 'arpg-equip', 'td-campaign', 'openworld-chain',
    'race-recipe', 'flight-recipe', 'recipe-shell-audit', 'character-sink-fix', 'hitscan', 'objective', 'projection', 'viewmodel-slots', 'blast', 'save-slot', 'arc-projectile', 'quality-controller', 'audio-duck', 'streak', 'vehicle-hulk', 'scale', 'bgm-layers', 'weather', 'kit-soldier', 'kit-gun', 'cloth-flags', 'fabric-texture', 'dome-terrain', 'time-of-day', 'terrain-shade', 'minimap', 'cooldown-gate', 'score-director', 'spatial-sfx', 'distance-trigger', 'hit-recoil', 'color-tone', 'slope', 'ammo-pool', 'linger', 'slope-steer', 'fuse', 'chain-blast', 'loss-tension', 'ambience', 'targeting', 'threshold-gate', 'step-sequencer', 'callout-tracker', 'damage-number', 'window-bar', 'ping-marker', 'combat-vfx', 'magazine-reload', 'arsenal-reserve', 'quest-countdown', 'minimap-dots', 'hotkey-hint', 'blast-present', 'ping-marker-tag', 'state-gate', 'vehicle-hulk-group', 'trail', 'arc-landing', 'hit-confirm', 'group-tint', 'motion', 'aim-node', 'prop-follower', 'dust-trail', 'nearest', 'smoke-handle', 'swept-circle', 'progress-gate', 'target-priority', 'hit-zone', 'formation', 'drop-table', 'clustered-dots'];
const outFiles = [];
